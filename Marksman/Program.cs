 ...
 */
                ...
                if (CClass.DrawingMenu(drawing))
                {
                    ...
                    */
                    drawing.AddItem(
                        new MenuItem("drawMinionLastHit", MenuSpace + "Minion Last Hit").SetValue(new Circle(true,
                            Color.GreenYellow)));
                    drawing.AddItem(
                        new MenuItem("drawMinionNearKill", MenuSpace + "Minion Near Kill").SetValue(new Circle(true,
                            Color.Gray)));
                    drawing.AddItem(
